...
public class InventoryHistoryPatchActivity extends InventoryImportPatchActivity {
    private static final String PATCH =
        ...
        "function typeLabel(t){return ({sale:'מכירה',purchase:'קבלת מלאי',adjustment:'התאמת מלאי',return:'החזרה',repair:'תיקון',adjust_in:'קבלת מלאי',adjust_out:'יציאת מלאי',serial_add:'רישום IMEI/סידורי'})[t]||t||'תנועה';}"+
