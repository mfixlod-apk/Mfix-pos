...
public class ReportsAnalyticsPatchActivity extends DailyClosingPatchActivity {
    private static final String PATCH =
        "(function(){if(window.__mfixReportsAnalyticsV2)return;window.__mfixReportsAnalyticsV2=true;"+
