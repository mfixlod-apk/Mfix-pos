...
public class DailyClosingPatchActivity extends SalesReturnPatchActivity {
    private static final String PATCH =
        "(function(){if(window.__mfixDailyClosingV2)return;window.__mfixDailyClosingV2=true;"+
