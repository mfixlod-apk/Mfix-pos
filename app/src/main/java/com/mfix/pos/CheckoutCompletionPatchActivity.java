...
public class CheckoutCompletionPatchActivity extends PaymentManagementPatchActivity {
    private static final String PATCH =
        ...
        "function receipt(sale){var lines=['MFIX POS','------------------------------','SALE '+sale.id,'TOTAL '+money(sale.total)+' NIS','PAID '+money(sale.payment.paid)+' NIS','METHOD '+String(sale.payment.method||'').toUpperCase(),'CHANGE '+money(sale.payment.change)+' NIS','------------------------------','Thank you!','\\n\\n'];return b64('\\x1b@'+lines.join('\\n')+'\\x1dV\\x00');}" +
